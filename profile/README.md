...
Transform isolated annotation efforts into cumulative scientific knowledge. Every lab annotating the same stimulus should be contributing to a shared resource that grows richer over time.
...
- Inconsistencies between annotation efforts confound meta-analyses
...
|---------|--------|-------------|
| **[NSD](https://naturalscenesdataset.org)** | Active | 73,000 COCO images from 7T fMRI study |
...
- **Read the vision**: [White Paper](https://github.com/Annotation-Garden/management/blob/main/agi-white-paper.md)
- **Contribute**: See our [Contributing Guide](https://github.com/Annotation-Garden/management/blob/main/CONTRIBUTING.md)
- **Discuss**: Open an issue in the [management repo](https://github.com/Annotation-Garden/management/issues)
